              ...
              <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{booking.bus_type}</p>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 items-center">
                ...
                <div className="flex flex-col space-y-2 border-l border-gray-100 pl-8">
                  <div className="flex items-center space-x-2 text-gray-600">
                    ...
                    <span className="text-sm">{new Date(booking.departure_time).toLocaleDateString()}</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-600">
                    <Clock className="w-4 h-4" />
                    <span className="text-sm">{new Date(booking.departure_time).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                  </div>
                </div>
